...
//系统log封装
#ifdef DEBUG //代表调试状态
#define GSLog_DEBUG(format, ...)    NSLog(@"[DEBUG] [%@:%d] {%s} " format, [NSString stringWithFormat:@"%s", __FILE__].lastPathComponent, __LINE__, __FUNCTION__,##__VA_ARGS__)
...
#define GSLog_ERROR(format, ...)    NSLog(@"[ERROR] [%@:%d] {%s} " format, [NSString stringWithFormat:@"%s", __FILE__].lastPathComponent, __LINE__, __FUNCTION__,##__VA_ARGS__)
#define GSLog_WARNING(format, ...)  NSLog(@"[WARNING] [%@:%d] {%s} " format, [NSString stringWithFormat:@"%s", __FILE__].lastPathComponent, __LINE__, __FUNCTION__,##__VA_ARGS__)
#else
#define GSLog_DEBUG(format,...)
#define GSLog_INFO(format,...)
#define GSLog_ERROR(format,...)
#define GSLog_WARNING(format,...)
#endif
